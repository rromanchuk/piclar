...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Code', fields ['value']
        db.create_unique('invitation_code', ['value'])


    def backwards(self, orm):
        # Removing unique constraint on 'Code', fields ['value']
        db.delete_unique('invitation_code', ['value'])
