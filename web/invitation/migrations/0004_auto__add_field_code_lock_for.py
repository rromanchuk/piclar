...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Code.lock_for'
        db.add_column('invitation_code', 'lock_for',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Code.lock_for'
        db.delete_column('invitation_code', 'lock_for')
    ...
    models = {
        ...
        'invitation.code': {
            ...
            'lock_for': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
