...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.lock_moderation'
        db.add_column('poi_place', 'lock_moderation',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.lock_moderation'
        db.delete_column('poi_place', 'lock_moderation')
