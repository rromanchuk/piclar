...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.review'
        db.delete_column('poi_place', 'review_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Place.review'
        db.add_column('poi_place', 'review',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poi.Review'], null=True, blank=True),
                      keep_default=False)
