...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlacePhoto.provider_url'
        db.add_column('poi_placephoto', 'provider_url',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlacePhoto.provider_url'
        db.delete_column('poi_placephoto', 'provider_url')
