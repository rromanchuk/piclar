...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.lock_moderation_user'
        db.add_column('poi_place', 'lock_moderation_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Place.moderated_by'
        db.add_column('poi_place', 'moderated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Place.moderated_date'
        db.add_column('poi_place', 'moderated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.lock_moderation_user'
        db.delete_column('poi_place', 'lock_moderation_user_id')

        # Deleting field 'Place.moderated_by'
        db.delete_column('poi_place', 'moderated_by_id')

        # Deleting field 'Place.moderated_date'
        db.delete_column('poi_place', 'moderated_date')
    ...
    models = {
        ...
        'poi.place': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['person.Person']", 'null': 'True'}),
            ...
            'lock_moderation_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'moderated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
