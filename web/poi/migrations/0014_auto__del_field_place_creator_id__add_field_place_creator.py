...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.creator_id'
        db.delete_column('poi_place', 'creator_id_id')

        # Adding field 'Place.creator'
        db.add_column('poi_place', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Place.creator_id'
        db.add_column('poi_place', 'creator_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'], null=True),
                      keep_default=False)

        # Deleting field 'Place.creator'
        db.delete_column('poi_place', 'creator_id')
