...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlacePhoto.url'
        db.delete_column('poi_placephoto', 'url')

        # Adding field 'PlacePhoto.original_url'
        db.add_column('poi_placephoto', 'original_url',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlacePhoto.file'
        db.add_column('poi_placephoto', 'file',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=2048, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PlacePhoto.url'
        db.add_column('poi_placephoto', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlacePhoto.original_url'
        db.delete_column('poi_placephoto', 'original_url')

        # Deleting field 'PlacePhoto.file'
        db.delete_column('poi_placephoto', 'file')
