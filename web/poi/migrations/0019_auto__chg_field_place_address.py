...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('poi_place', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Place.address'
        db.alter_column('poi_place', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
