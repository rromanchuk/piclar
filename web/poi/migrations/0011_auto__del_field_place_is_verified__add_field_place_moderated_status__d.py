...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.is_verified'
        db.delete_column('poi_place', 'is_verified')

        # Adding field 'Place.moderated_status'
        db.add_column('poi_place', 'moderated_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PlacePhoto.is_verified'
        db.delete_column('poi_placephoto', 'is_verified')

        # Adding field 'PlacePhoto.moderated_status'
        db.add_column('poi_placephoto', 'moderated_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Place.is_verified'
        db.add_column('poi_place', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Place.moderated_status'
        db.delete_column('poi_place', 'moderated_status')

        # Adding field 'PlacePhoto.is_verified'
        db.add_column('poi_placephoto', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PlacePhoto.moderated_status'
        db.delete_column('poi_placephoto', 'moderated_status')
