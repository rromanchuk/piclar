...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlacePhoto.is_deleted'
        db.delete_column('poi_placephoto', 'is_deleted')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PlacePhoto.is_deleted'
        db.add_column('poi_placephoto', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
