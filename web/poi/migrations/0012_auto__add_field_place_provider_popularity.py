...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.provider_popularity'
        db.add_column('poi_place', 'provider_popularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.provider_popularity'
        db.delete_column('poi_place', 'provider_popularity')
