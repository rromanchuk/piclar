...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Checkin.review'
        db.alter_column('poi_checkin', 'review', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Checkin.review'
        db.alter_column('poi_checkin', 'review', self.gf('django.db.models.fields.TextField')(default=''))
