...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonEdge.is_deleted'
        db.add_column('person_personedge', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'PersonEdge', fields ['edge_to', 'edge_from']
        db.create_unique('person_personedge', ['edge_to_id', 'edge_from_id'])

        # Adding unique constraint on 'SocialPersonEdge', fields ['person_2', 'person_1']
        db.create_unique('person_socialpersonedge', ['person_2_id', 'person_1_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SocialPersonEdge', fields ['person_2', 'person_1']
        db.delete_unique('person_socialpersonedge', ['person_2_id', 'person_1_id'])

        # Removing unique constraint on 'PersonEdge', fields ['edge_to', 'edge_from']
        db.delete_unique('person_personedge', ['edge_to_id', 'edge_from_id'])

        # Deleting field 'PersonEdge.is_deleted'
        db.delete_column('person_personedge', 'is_deleted')
