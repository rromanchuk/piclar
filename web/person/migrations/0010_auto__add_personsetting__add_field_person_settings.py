...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonSetting'
        db.create_table('person_personsetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data', self.gf('ostrovok_common.models.JSONField')()),
        ))
        db.send_create_signal('person', ['PersonSetting'])

        # Adding field 'Person.settings'
        db.add_column('person_person', 'settings',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['person.PersonSetting'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PersonSetting'
        db.delete_table('person_personsetting')

        # Deleting field 'Person.settings'
        db.delete_column('person_person', 'settings_id')
