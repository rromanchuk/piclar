...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.checkins_count'
        db.add_column('person_person', 'checkins_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.checkins_count'
        db.delete_column('person_person', 'checkins_count')
