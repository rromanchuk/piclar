...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialPerson.external_id'
        db.alter_column('person_socialperson', 'external_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'SocialPerson.external_id'
        db.alter_column('person_socialperson', 'external_id', self.gf('django.db.models.fields.IntegerField')())
