...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialPerson.token'
        db.alter_column('person_socialperson', 'token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'SocialPerson.token'
        db.alter_column('person_socialperson', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
