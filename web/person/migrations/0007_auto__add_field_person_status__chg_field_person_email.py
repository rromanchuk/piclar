...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('person_person', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


        # Changing field 'Person.email'
        db.alter_column('person_person', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):
        # Deleting field 'Person.status'
        db.delete_column('person_person', 'status')
