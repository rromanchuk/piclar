...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.following'
        db.add_column('person_person', 'following',
                      self.gf('ostrovok_common.pgarray.fields.IntArrayField')(default=''),
                      keep_default=False)

        # Adding field 'Person.followers'
        db.add_column('person_person', 'followers',
                      self.gf('ostrovok_common.pgarray.fields.IntArrayField')(default=''),
                      keep_default=False)

        # renaming field 'PersonEdge.person_2'
        db.rename_column('person_personedge', 'person_2_id', 'edge_to_id')

        # renaming field 'PersonEdge.person_1'
        db.rename_column('person_personedge', 'person_1_id', 'edge_from_id')



    def backwards(self, orm):
        # Deleting field 'Person.following'
        db.delete_column('person_person', 'following')

        # Deleting field 'Person.followers'
        db.delete_column('person_person', 'followers')


        # renaming field 'PersonEdge.person_2'
        db.rename_column('person_personedge',  'edge_to_id', 'person_2_id')

        # renaming field 'PersonEdge.person_1'
        db.rename_column('person_personedge', 'edge_from_id', 'person_1_id')
    ...
    models = {
        ...
        'person.person': {
            ...
            'followers': ('ostrovok_common.pgarray.fields.IntArrayField', [], {'default': '[]'}),
            'following': ('ostrovok_common.pgarray.fields.IntArrayField', [], {'default': '[]'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
