...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialPerson.profile_url'
        db.add_column('person_socialperson', 'profile_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialPerson.profile_url'
        db.delete_column('person_socialperson', 'profile_url')
