...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.sex'
        db.add_column('person_person', 'sex',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SocialPerson.sex'
        db.add_column('person_socialperson', 'sex',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.sex'
        db.delete_column('person_person', 'sex')

        # Deleting field 'SocialPerson.sex'
        db.delete_column('person_socialperson', 'sex')
