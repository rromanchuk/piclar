...
urlpatterns = patterns('',
    ...
    url(r'^v1/person/logged/fullinfo\.(?P<content_type>xml|json)$', PersonFollowingFollowers.view, name='api_person_following_followers'),
    url(r'^v1/person/(?P<pk>\d+|logged)/followingfollowers\.(?P<content_type>xml|json)$', PersonFollowingFollowers.view, name='api_person_following_followers'),
    url(r'^v1/person/(?P<pk>\d+|logged)/suggested\.(?P<content_type>xml|json)$', PersonSuggested.view, name='api_person_suggested'),
