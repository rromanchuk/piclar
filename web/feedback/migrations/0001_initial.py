...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feedback_feedback', (
            ...
            ('page_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
    ...
    models = {
        ...
        'feedback.feedback': {
            ...
            'page_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
