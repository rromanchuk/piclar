...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PersonAPNDeviceToken'
        db.delete_table('notification_personapndevicetoken')

        # Adding model 'APNDeviceToken'
        db.create_table('notification_apndevicetoken', (
        ...
        db.send_create_signal('notification', ['APNDeviceToken'])


    def backwards(self, orm):
        # Adding model 'PersonAPNDeviceToken'
        db.create_table('notification_personapndevicetoken', (
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['person.Person'], unique=True)),
        ...
        db.send_create_signal('notification', ['PersonAPNDeviceToken'])

        # Deleting model 'APNDeviceToken'
        db.delete_table('notification_apndevicetoken')
    ...
    models = {
        ...
        'notification.apndevicetoken': {
            'Meta': {'object_name': 'APNDeviceToken'},
